...
def perform_gap_analysis(resume_skills: list,
    ...
    overlapping   = [
        s for s in required_skills if s.lower() in resume_lower
    ]
    gap_skills    = [
        s for s in required_skills if s.lower() not in resume_lower
    ]
    preferred_gap = [
        s for s in preferred_skills if s.lower() not in resume_lower
    ]
...
def compute_advanced_score(resume_skills: list,
    ...
    preferred_match = [
        s for s in preferred_skills if s.lower() in resume_lower
    ]
