...
```
.
├── AI-Adaptive onboarding engine.py
├── LICENSE
└── two_phase_skill_pipeline.svg
```
...
2. **Clone** your fork: `git clone https://github.com/pranesh-S-S/AI-Adaptive-Onboarding-Engine.git`
